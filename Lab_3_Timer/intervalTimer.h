...
#define INTERVAL_TIMER_STATUS_OK 1 // Return 1 this status if successful.
#define INTERVAL_TIMER_STATUS_FAIL 0 // Return 0 this status if failure.

#define INTERVAL_TIMER_TIMER_0 0//TIMER 0
#define INTERVAL_TIMER_TIMER_1 1//TIMER 1
#define INTERVAL_TIMER_TIMER_2 2//TIMER 2
