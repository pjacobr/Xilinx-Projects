...
#include "../Lab_3_Timer/intervalTimer.h"  // Modify as necessary to point to your intervalTimer.h
#include "supportFiles/leds.h"
#include "supportFiles/interrupts.h"
#include "../Lab_2/switches.h"  // Modify as necessary to point to your switches.h
#include "../Lab_2/buttons.h"   // Modify as necessary to point to your buttons.h
#include <stdio.h>
